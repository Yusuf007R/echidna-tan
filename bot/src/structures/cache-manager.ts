...
export default class CacheManager {
  ...
  static set: (typeof CacheManager._cache)['set'] = (...args) => this._cache.set(...args);
  static get: (typeof CacheManager._cache)['get'] = (...args) => this._cache.get(...args);
  static delete: (typeof CacheManager._cache)['delete'] = (...args) => this._cache.delete(...args);
}
